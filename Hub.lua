...
TargetTab:CreateDropdown({Name = "Select Target Player", Options = GetPlayerNames(), Callback = function(Option) _G.DW_TargetPlayer = Option[1] end})
